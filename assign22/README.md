...
This project is a smaall backend-focused web app that fetches third-party data **only on the server**, then serves a clean UI that displays the processed results.
